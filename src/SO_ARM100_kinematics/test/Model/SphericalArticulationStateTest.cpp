...
{
	auto state = Model::SphericalArticulationState( spherical_articulation_.get() );
...
TEST_F( SphericalArticulationStateTest, UpdateValues_BoneOffAxisWithRotationTranslation_ExpectedResult )
{
	auto state = Model::SphericalArticulationState( spherical_articulation_.get() );
...
TEST_F( SphericalArticulationStateTest, UpdateValues_BoneOffAxisConsistency_ExpectedResult )
{
	auto state = Model::SphericalArticulationState( spherical_articulation_.get() );
